DEFAULT_START_PORT=10009                         #默认起始端口
DEFAULT_SOCKS_USERNAME="meng"                   #默认socks账号
DEFAULT_SOCKS_PASSWORD="Aa.633958"               #默认socks密码
...
install_xray() {
	...
	wget https://almeng.oss-cn-qingdao.aliyuncs.com/Linux/Xray-linux-64.zip
